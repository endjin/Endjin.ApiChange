// <copyright file="PdbDownLoader.cs" company="Endjin">
    ...
    internal class PdbDownLoader
    {
        ...
        public bool DownloadPdbs(FileQuery query, string symbolServer, string downloadDir)
        {
            using (var t = new Tracer(MyType, "DownloadPdbs"))
            {
                ...
                var dispatcher = new WorkItemDispatcher<string>(this.myDownLoadThreadCount, downLoadPdbThread,
                    "Pdb Downloader", aggregator, WorkItemOptions.AggregateExceptions);
