// <copyright file="WhoUsesStringConstant.cs" company="Endjin">
...
namespace Endjin.ApiChange.Api.Query.UsageQueries
{
    ...
    public class WhoUsesStringConstant : UsageVisitor
    {
        ...
        public WhoUsesStringConstant(UsageQueryAggregator aggregator, string searchString)
            : this(
            aggregator,
            searchString, false, StringComparison.OrdinalIgnoreCase)
        {
        }

        public WhoUsesStringConstant(UsageQueryAggregator aggregator, string searchString, bool bExactMatch)
            : this(
            aggregator, searchString, bExactMatch, StringComparison.OrdinalIgnoreCase)
        {
        }
