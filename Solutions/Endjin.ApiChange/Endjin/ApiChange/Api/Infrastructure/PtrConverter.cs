// <copyright file="PtrConverter.cs" company="Endjin">
...
namespace Endjin.ApiChange.Api.Infrastructure
{
    ...
    public class PtrConverter<T>
    {
        ...
        private static void GenerateDynamicMethod()
        {
            if (myConverter == null)
            {
                var method = new DynamicMethod("ConvertPtrToObjReference", typeof(T), new[] { typeof(IntPtr) },
                    StaticModule.UnsafeModule);
