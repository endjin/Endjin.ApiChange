// <copyright file="ExceptionHelper.cs" company="Endjin">
...
namespace Endjin.ApiChange.Api.Infrastructure
{
    ...
    public static class ExceptionHelper
    {
        ...
        public static bool InException
        {
            ...
            {
                // TODO
                return false; // Marshal.GetExceptionPointers() == IntPtr.Zero && Marshal.GetExceptionCode() == 0 ? false : true;
            }
        }
        ...
        public static bool IsFatal(Exception ex)
        {
            if (!(ex is NullReferenceException) && !(ex is StackOverflowException) && !(ex is OutOfMemoryException) &&
                !(ex is ThreadAbortException) && !(ex is IndexOutOfRangeException) &&
