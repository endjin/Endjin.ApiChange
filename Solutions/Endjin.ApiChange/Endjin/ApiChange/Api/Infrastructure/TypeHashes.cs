// <copyright file="TypeHashes.cs" company="Endjin">
...
namespace Endjin.ApiChange.Api.Infrastructure
{
    ...
    public class TypeHashes
    {
        ...
        public TypeHashes(string typeName)
        {
            ...
            foreach (string substr in this.FullQualifiedTypeName.ToLower().Split(MySep))
            {
        ...
        public TypeHashes(Type t)
            : this(CheckInput(t))
        {
        }

        internal string FullQualifiedTypeName { get; }
