// <copyright file="FileQuery.cs" company="Endjin">
...
namespace Endjin.ApiChange.Api.Infrastructure
{
    ...
    public class FileQuery
    {
            ...
            get
            {
                ...
                if (this.UseCwd)
                {
                    return Path.GetFullPath(Path.Combine(
                        ...
                        Path.GetDirectoryName(this.Query)));
                }
        ...
        public string[] Files
        {
            get
            {
                ...
                if (this.mySearcher != null)
                {
                    ...
                    foreach (string file in this.mySearcher.GetResultQueue())
                    {
                        matches.Add(file);
                    }
        ...
        public string GetMatchingFileByName(string fileName)
        {
            ...
            foreach (string file in this.EnumerateFiles)
            {
